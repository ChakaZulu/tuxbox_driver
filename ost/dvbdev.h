 ...
 *
 * $Id: dvbdev.h,v 1.14 2002/05/08 13:21:50 obi Exp $
 */
...
struct dvb_device
{
	...
	devfs_handle_t devfs_handle_dvb_card;
	devfs_handle_t devfs_handle_dvb_device[DVB_DEVICES_NUM];
	struct dvbdev_devfsinfo devfs_info[DVB_DEVICES_NUM];

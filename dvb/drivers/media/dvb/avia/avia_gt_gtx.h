...
#define GTX_IRQ_PE		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 0)
#define GTX_IRQ_CD		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 1)
#define GTX_IRQ_MC		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 2)
#define GTX_IRQ_PO		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 3)
#define GTX_IRQ_NR		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 4)
#define GTX_IRQ_WT		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 5)
#define GTX_IRQ_LOCK		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 6)
#define GTX_IRQ_DROP		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 7)
#define GTX_IRQ_PCR		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 8)
#define GTX_IRQ_IDC		AVIA_GT_IRQ(GTX_IRQ_REG_ISR0, 9)
#define GTX_IRQ_TC		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 0)
#define GTX_IRQ_TE		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 1)
#define GTX_IRQ_TW		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 2)
#define GTX_IRQ_TL		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 3)
#define GTX_IRQ_RC		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 4)
#define GTX_IRQ_RE		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 5)
#define GTX_IRQ_RW		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 6)
#define GTX_IRQ_RL		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 7)
#define GTX_IRQ_IT		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 8)
#define GTX_IRQ_IR		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 9)
#define GTX_IRQ_PF		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 10)
#define GTX_IRQ_VL0		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 11)
#define GTX_IRQ_AD		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 12)
#define GTX_IRQ_VL1		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 13)
#define GTX_IRQ_VD		AVIA_GT_IRQ(GTX_IRQ_REG_ISR1, 14)

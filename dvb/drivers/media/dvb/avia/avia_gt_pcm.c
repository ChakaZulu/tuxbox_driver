/*
 * $Id: avia_gt_pcm.c,v 1.24 2003/07/24 01:14:20 homar Exp $
 *
...
int avia_gt_pcm_init(void)
{
	...
	dprintk(KERN_INFO "avia_gt_pcm: $Id: avia_gt_pcm.c,v 1.24 2003/07/24 01:14:20 homar Exp $\n");
	...
	if (avia_gt_alloc_irq(gt_info->irq_pcmad, avia_gt_pcm_irq)) {
		dprintk("avia_gt_pcm: unable to get pcm-ad interrupt\n");
		return -EIO;
	}

	if (avia_gt_alloc_irq(gt_info->irq_pcmpf, avia_gt_pcm_irq)) {
		dprintk("avia_gt_pcm: unable to get pcm-pf interrupt\n");

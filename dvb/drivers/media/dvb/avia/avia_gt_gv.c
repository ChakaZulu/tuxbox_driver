/*
 * $Id: avia_gt_gv.c,v 1.32 2003/07/24 01:14:20 homar Exp $
 *
...
{
	dprintk(KERN_INFO "avia_gt_gv: set_input_mode (mode=%d)\n", mode);
...
{
	dprintk(KERN_INFO "avia_gt_gv: set_input_size (width=%d, height=%d)\n", width, height);
...
{
	dprintk(KERN_INFO "avia_gt_gv: $Id: avia_gt_gv.c,v 1.32 2003/07/24 01:14:20 homar Exp $\n");

/*
 * $Id: avia_gt_oss.c,v 1.20 2003/07/24 01:14:20 homar Exp $
 *
...
int avia_oss_dsp_ioctl(struct inode *inode, struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case SNDCTL_SEQ_GETTIME:
		dprintk("avia_oss: IOCTL: SNDCTL_SEQ_GETTIME\n");
		return -1;
	...
	default:
		dprintk("avia_oss: IOCTL: unknown (cmd=%d)\n", cmd);
		return -EINVAL;
	}
...
{
	dprintk(KERN_INFO "avia_oss: $Id: avia_gt_oss.c,v 1.20 2003/07/24 01:14:20 homar Exp $\n");

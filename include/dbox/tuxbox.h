...
#define TUXBOX_VERSION					KERNEL_VERSION(1,0,0)

#define	TUXBOX_MANUFACTURER_UNKOWN		0x0000
...
#define TUXBIX_MODEL_DREAMBOX_DM7000	0x0002
#define TUXBIX_MODEL_DREAMBOX_DM5600	0x0003

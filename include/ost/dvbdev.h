 ...
 *
 * $Id: dvbdev.h,v 1.2 2001/03/03 08:24:25 waldi Exp $
 */
...
extern int dvb_device_init ();
extern int dvb_register_device ( struct dvb_device * );
extern void dvb_unregister_device ( struct dvb_device * );

extern int dvb_device_open ( int, struct inode *, struct file * );
extern int dvb_device_close ( int, struct inode *, struct file * );
extern ssize_t dvb_device_write ( int, struct file *, const char *, 
				  size_t, loff_t * );
extern ssize_t dvb_device_read ( int, struct file *file, char *buf, 
			         size_t, loff_t * );
extern int dvb_device_ioctl ( int, struct file *, unsigned int, unsigned long );
extern unsigned int dvb_device_poll ( int, struct file *, poll_table * );
